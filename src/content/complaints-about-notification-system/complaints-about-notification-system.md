...
これが本題といえば本題なのですが、少なくとも[私](https://x.com/Uliboooo)の環境で2026/05/31時点ではちょいちょいDMの一覧を開いただけで未読のバッジが消えることがあります。まだメッセージ本体を開いてないのに。プレビュー程度しか見てないのに見たことにされるのは上記のデメリットを綺麗に実装しています。
